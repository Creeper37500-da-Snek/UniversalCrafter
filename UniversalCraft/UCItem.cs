...
{
	public class UCItem : GlobalItem
	{
		public override bool UseItem(Item item, Player player)
		{
			if (ItemID.Sets.ExtractinatorMode[player.inventory[player.selectedItem].type] >= 0 && Main.tile[Player.tileTargetX, Player.tileTargetY].active() && Main.tile[Player.tileTargetX, Player.tileTargetY].type == mod.TileType("UniversalCrafter") && player.whoAmI == Main.myPlayer)
			{
